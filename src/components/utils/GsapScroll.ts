...
export function setCharTimeline(
  ...
  const targetMonitor = monitor as THREE.Mesh | null;
  const targetScreenLight = screenLight as THREE.Mesh | null;
  if (targetMonitor) {
    tl3.to((targetMonitor.material as THREE.Material), { opacity: 1, duration: 0.8, delay: 3.2 }, 0);
    tl3.fromTo(
  ...
  if (targetScreenLight) {
    tl3.to((targetScreenLight.material as THREE.Material), { opacity: 1, duration: 0.8, delay: 4.5 }, 0);
  }
      tl3
        .fromTo(
          ".what-box-in",
